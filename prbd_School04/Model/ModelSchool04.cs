...
namespace School04.Model {
    public class ModelSchool04 : DbContextBase {
        ...
        public void SeedData() {
            ...
            var anc3 = new Course(1868, "ANC3", "Projet d'analyse et de conception", Benoit);
            var map4 = new Course(1914, "MAP4", "Mathématique appliquées à l'informatique", Benoit);
            var prbd = new Course(1975, "PRBD", "Projet de développement SGBD", Benoit);
            var sgbd = new Course(1976, "PRBB", "Projet de développement SGBD", Boris);
            var prm2 = new Course(1900, "PRM2", "Principes algorithmiques et programmation", Boris);
            var prwb = new Course(1930, "PRWB", "Projet de développement Web", Benoit);
            var tgpr = new Course(1963, "TGPR", "Technique de gestion de projets", Benoit);
